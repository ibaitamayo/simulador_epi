      ...
      div(class = "workflow-guide-box",
        conditionalPanel(
          ...
          tags$ol(
            ...
            tags$li("Set initial expansion, active duration and average mortality."),
        ...
        conditionalPanel(
          ...
          tags$ol(
            ...
            tags$li("Activa calibración o robustez solo si vas a interpretar diagnósticos."),
            ...
            fluidRow(
              column(6,
                ...
                tags$ul(
                  ...
                  tags$li("Aparición de variantes con ventaja"),
...
server <- function(input, output, session) {
  ...
  capture_current_scenario_config <- function() {
    list(
      app_file = "app_epidemiologic_v16_scenario_lab_step6_presets_guided_exploration_ES_fix3.R",
  ...
  output$reference_comparator_metadata_table <- renderTable({
    data.frame(
      ...
      Value = c(
        ...
        "4.25",
        "5 days",
        "1% in current basic comparator",
        "Disabled in comparator",
        "No",
        "Read from RDS; sliced to selected duration; not recalculated by Calculate simulation"
      ),
      stringsAsFactors = FALSE
    )
  }, rownames = FALSE)
  ...
  output$evaluation_report <- renderText({
    ...
    lines <- c(
      ...
      paste0("app_file=app_epidemiologic_v16_scenario_lab_step6_presets_guided_exploration_ES_fix3.R"),
      paste0("active_scenario_mode=", isolate(input$active_scenario_mode)),
